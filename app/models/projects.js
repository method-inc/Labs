...
Projects.prototype.find_all = function(callback) {
  ...
  projects = {
    featured: [
      {name: 'Clickdummy', link: 'https://clickdummy.com', screenshot:'clickdummy.jpg', tags:['html5', 'css3', 'knockoutjs']}
    ],
    ...
    demos: [
      ...
      {name: 'KnockoutJS ToDo List', link: '/demos/knockout_todos', screenshot:'knockout_todos.jpg',  tags:['html5', 'canvas', 'knockoutjs']},
